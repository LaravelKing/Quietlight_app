...
<html lang="en">
<head>
    <title>CSV Uploading & Show Chart</title>
...
<body>
    ...
    <script>
        var columnName = [];
        var dataRaw, dataMain, dataMain2;
        var is_found = false;
        $(document).ready(function() {
            ...
            $("button#js-btn-draw").click(function() {
                ...
                for (var i = 1; i <= 12; i++) {
                    if (i < 10) {
                        graphData3[i] = [arrMonthName[i - 1], tempGraphData3["0" + i]];
                    } else {
                        graphData3[i] = [arrMonthName[i - 1], tempGraphData3[i + ""]];
                    }
                }
        ...
        // file uploading callback function
